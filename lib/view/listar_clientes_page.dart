...
//OBTERTODOS
  Future<List<Cliente>> _obterTodos() async {
    ...
    try {
      ...
      showError(
          context, "Erro obtendo lista de cleintes", exception.toString());
    }
...
//REMOVEBOI
  void _removerCliente(int id) async {
    try {
      ...
      showError(context, "Erro removendo cleinte", exception.toString());
    }
  }
...
//SHOWITEM NOVO DAO
/*  void _showItem(BuildContext context, int index) {
    Cleinte cleinte = _lista[index];
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
              title: Text(cleinte.nome),
              content: Column(
                ...
                children: [
                  Row(children: [
                    Icon(Icons.create),
                    Text("Nome: ${cleinte.nome}")
                  ]),
                  Row(children: [
                    Icon(Icons.assistant_photo),
                    Text("Raça: ${cleinte.raca}")
                  ]),
                  Row(children: [
                    Icon(Icons.cake),
                    Text("Idade: ${cleinte.idade} anos")
                  ]),
                ],
              ),
              actions: [
