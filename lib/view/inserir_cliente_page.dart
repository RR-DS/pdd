...
//SALVAR - INT COM BANCO - ANTIGO
  /* void _salvar() async {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text('Cleinte salvo com sucesso')));
  }
*/
...
/*
  void _salvar() async {
    ...
    Cleinte cleinte = Cliente.novo(_nomeController.text, _racaController.text,
        int.parse(_idadeController.text));
    await dao.inserir(cleinte);
